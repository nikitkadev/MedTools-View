...
import type { InjDate, Injection } from "../../types/categories/Oncology/InjectionsQueryResult";
import { create } from "zustand";

interface OncologyCategoryStore {
    oncServiceUid: number | null;
    oncSluchUid: number | null;
    medicamentUid: number | null;
    ...
    setMedicamentUid: (uid: number) => void;
    ...
    setInjDates: (dates: InjDate[]) => void;
    setInjs: (injs: Injection[]) => void;
}
