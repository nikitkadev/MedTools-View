    ...
    <section className={styles.oncologyRoot}>
      <div className={styles.categoryLine}>
        ...
        {selectedMedicalCaseUid === null ? (
          <DataState
            ...
            description="Нажмите на карточку медицинского случая для отображения данных о онкологическом случае и проведенных консилиумах"
            variant="waiting"
          />
        ) : (
      ...
      <div className={styles.categoryLine}>
        ...
        {oncologyCaseUid === null ? (
          <DataState
            title="Дождитесь выбора онкологического случая"
            description="Дождитесь автоматического выбора онкологического случая для отображения диагностического блока, противопоказаниях и онкологических услуг"
            variant="waiting"
          />
        ) : (
          <>
      ...
      <div className={styles.categoryLine}>
        ...
        {selectedMedicationUid === null ? (
          <DataState
            ...
            description="Нажмите на карточку лекраственного препарата для отображения данных о датах введения препарата и инъекциях"
            variant="waiting"
          />
        ) : (
